...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
      ...
      w-[50vw]' fill="purple" />
      <Spotlight className='top-20 left-80 h-[80vh] 
      w-[50vw]' fill="blue" />
      <div className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.03] bg-grid-black/[0.05]  flex items-center justify-center 
      ...
      <div className='flex justify-center relative my-20 z-10 '>
        ...
        flex flex-col items-end justify-end'>
          ...
          text-blue-100 max-w-80'>Dynamic
